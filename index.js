...
function showBanner() {
  ...
  console.log(chalk.yellow('║') + chalk.bold.blue(' ██████ ██████  ██    ██ ██████  ████████  ██████  ██     ██  █████  ██    ██ ███████ ') + chalk.yellow(' ║'));
  console.log(chalk.yellow('║') + chalk.bold.blue('██      ██   ██ ╚██  ██  ██    ██    ██       ██     ██ ██   ██ ██    ██ ██      ') + chalk.yellow(' ║'));
  console.log(chalk.yellow('║') + chalk.bold.blue('██      ██████   ╚████╔╝ ██    ██████      ██      ██  █  ██ ███████ ██    ██ █████   ') + chalk.yellow(' ║'));
  console.log(chalk.yellow('║') + chalk.bold.blue('██      ██   ██   ╚██╔╝  ██    ██   ██    ██      ██ ███ ██ ██   ██ ╚██  ██  ██      ') + chalk.yellow(' ║'));
  console.log(chalk.yellow('║') + chalk.bold.blue(' ██████ ██   ██    ██    ██████ ██████     ██████   ╚███╔███╔ ██   ██  ╚████╔╝ ███████ ') + chalk.yellow(' ║'));
  ...
  console.log(chalk.blue('│') + chalk.bold.white(' 💰 CryptoWave Account Creator v1.0 - Mining Bot') + chalk.blue(' '.repeat(27) + '│'));
  console.log(chalk.blue('│') + chalk.bold.magenta(' 🔗 https://cryptowave.blog/auth?ref=EARNB8A993') + chalk.blue(' '.repeat(31) + '│'));
  console.log(chalk.blue('│') + chalk.bold.green(' 🎯 Auto Registration | Temp Email | Fixed Password') + chalk.blue(' '.repeat(20) + '│'));
  console.log(chalk.blue('└─────────────────────────────────────────────────────────────────────────────┘'));
  console.log(chalk.cyan('┌─────────────────────────────────────────────────────────────────────────────┐'));
  console.log(chalk.cyan('│') + chalk.bold.red(' 💻 Coded by: ') + chalk.bold.white('lhuciver') + chalk.cyan(' '.repeat(57) + '│'));
  console.log(chalk.cyan('│') + chalk.bold.blue(' 🔗 GitHub: ') + chalk.bold.white('github.com/lhuciver') + chalk.cyan(' '.repeat(47) + '│'));
  console.log(chalk.cyan('│') + chalk.bold.green(' 📱 Telegram: ') + chalk.bold.white('@lhuciver') + chalk.cyan(' '.repeat(49) + '│'));
  console.log(chalk.cyan('└─────────────────────────────────────────────────────────────────────────────┘'));
  console.log('');
}
...
(async () => {
  ...
  console.log(chalk.bold.green('║') + chalk.bold.white(' 🔗 https://cryptowave.blog/auth?ref=EARNB8A993') + chalk.green(' '.repeat(33) + '║'));
  console.log(chalk.bold.green('╚══════════════════════════════════════════════════════════════════════════════╝'));

  // Footer with additional info
  console.log('');
  console.log(chalk.gray('┌─ Script Information ──────────────────────────────────────────────────────┐'));
  console.log(chalk.gray('│') + chalk.bold.cyan(' 🔧 Version: ') + chalk.white('1.0 Premium') + chalk.gray(' '.repeat(54) + '│'));
  console.log(chalk.gray('│') + chalk.bold.cyan(' 🛡️  Security: ') + chalk.white('Proxy + Temp Email') + chalk.gray(' '.repeat(40) + '│'));
  console.log(chalk.gray('│') + chalk.bold.cyan(' ⚡ Speed: ') + chalk.white('3-8 sec per account') + chalk.gray(' '.repeat(42) + '│'));
